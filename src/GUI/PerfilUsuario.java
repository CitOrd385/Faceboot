...
public class PerfilUsuario extends javax.swing.JFrame {
    ...
    private void btnAgregarMusicaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarMusicaActionPerformed
        if (!txtGustosMusicales.getText().equals("")) {
            generosMusicales.add(txtGustosMusicales.getText());
            txtGustosMusicales.setText("");
        }else{
            JOptionPane.showMessageDialog(this, "No hay datos que guardar, llene el campo", "Error", JOptionPane.INFORMATION_MESSAGE);
        }
    ...
    private void btnAgregarPeliculas1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarPeliculas1ActionPerformed
       if (!txtGenerosPeliculas.getText().equals("")) {
            generosPeliculas.add(txtGenerosPeliculas.getText());
            txtGenerosPeliculas.setText("");
        }else{
            JOptionPane.showMessageDialog(this, "No hay datos que guardar, llene el campo", "Error", JOptionPane.INFORMATION_MESSAGE);
        } 
    ...
    public void actualizarDatosUsuario() {
        if (!txtNombre.getText().equals("") && !txtContrasenia.getText().equals("")) {
            Usuario user = new Usuario();
            user.setNombre(txtNombre.getText());
            user.setContraseña(txtContrasenia.getText());

            if (this.usuario.getGenerosMusica() != null) {
                this.generosMusicales.addAll(usuario.getGenerosMusica());
            }

            if (this.usuario.getGenerosPeliculas() != null) {
                this.generosPeliculas.addAll(usuario.getGenerosPeliculas());
            }

            usuario.setGenerosMusica(generosMusicales);
            ...
            JOptionPane.showMessageDialog(this, "Se han guardado los cambios", "Exito", JOptionPane.INFORMATION_MESSAGE);
             ...
             MuroPosts muro= new MuroPosts(usuario);
             muro.setVisible(true);
            dispose();
            
        }else{
            JOptionPane.showMessageDialog(this, "No se guardaron los cambios", "Error", JOptionPane.INFORMATION_MESSAGE);
        }
    ...
    public void eliminarGenerosMusicales() {
        this.usuario.getGenerosMusica().remove(cmbGenerosMusicales.getSelectedItem());
        this.cargarComboMusica();
    }

    public void eliminarGenerosPeliculas() {
        this.usuario.getGenerosPeliculas().remove(cmbGenerosPeliculas.getSelectedItem());
        this.cargarComboPeliculas();
    }
